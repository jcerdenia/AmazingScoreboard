...
private const val NUM_OF_PLAYERS = 6

class SixPlayerFragment : PlayerFragment() {

    private val fragment = this@SixPlayerFragment
    private val layout = R.layout.fragment_sixplayer
