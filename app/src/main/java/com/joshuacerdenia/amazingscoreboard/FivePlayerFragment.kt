...
private const val NUM_OF_PLAYERS = 5

class FivePlayerFragment : PlayerFragment() {

    private val fragment = this@FivePlayerFragment
    private val layout = R.layout.fragment_fiveplayer
    ...
    override fun onStart() {
        ...
        prepareSharedPreferences(this.activity!!)
        loadPlayerData()
